...
// Glow colors matching each technology's brand color
const GLOW_COLORS: Record<string, string> = {
  python:  "drop-shadow-[0_0_6px_rgba(55,118,184,0.8)]  group-hover:drop-shadow-[0_0_12px_rgba(55,118,184,1)]",
  sql:     "drop-shadow-[0_0_6px_rgba(0,200,255,0.8)]   group-hover:drop-shadow-[0_0_12px_rgba(0,200,255,1)]",
  excel:   "drop-shadow-[0_0_6px_rgba(16,124,65,0.9)]   group-hover:drop-shadow-[0_0_12px_rgba(16,124,65,1)]",
  r:       "drop-shadow-[0_0_6px_rgba(39,107,158,0.8)]  group-hover:drop-shadow-[0_0_12px_rgba(39,107,158,1)]",
  powerbi: "drop-shadow-[0_0_6px_rgba(242,200,17,0.8)]  group-hover:drop-shadow-[0_0_12px_rgba(242,200,17,1)]",
  looker:  "drop-shadow-[0_0_6px_rgba(66,133,244,0.8)]  group-hover:drop-shadow-[0_0_12px_rgba(66,133,244,1)]",
  git:     "drop-shadow-[0_0_6px_rgba(240,80,50,0.8)]   group-hover:drop-shadow-[0_0_12px_rgba(240,80,50,1)]",
  jupyter: "drop-shadow-[0_0_6px_rgba(243,118,38,0.8)]  group-hover:drop-shadow-[0_0_12px_rgba(243,118,38,1)]",
};

const getLogo = (id: string) => {
  const glow = GLOW_COLORS[id] ?? "";
  switch (id) {
    case "python":
      return (
        <svg viewBox="0 0 24 24" className={`w-9 h-9 transition-all duration-300 group-hover:scale-110 ${glow}`} fill="none" xmlns="http://www.w3.org/2000/svg">
